...
foreach ( $viewers as $key => $value ) {
	$viewerslist .= sprintf_safe( '<li><a href="%1$s" target=_blank>%2$s</a></li>', $value, $key );
}
$viewerslist      .= '</ul>';
...
<ol>
  ...
  </li><li>' . sprintf_safe( __( 'Add %1$s to your viewer', 'w4os' ), $gridname, ) . '
  ...
  <li>' . __( 'Log in', 'w4os' ) . '
    <ul>
      <li>' . sprintf_safe( __( 'Make sure %1$s is selected in the Grid menu', 'w4os' ), $gridname ) . '</li>
