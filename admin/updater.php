...
// 	$version_info="$version_info (update availailable: $remote_version, <a href='$download_link'>download zip</a> or <a href='$repo_url' target=_blank>pull from git repository</a>)";
// }
